...
ffmpeg -r 30 -f image2 -pattern_type glob -i "${FULLPATH}/network-tylegw-internet_*.png" -vcodec libx264 \
-crf 23 -pix_fmt yuv420p ${LOGPARENT}/network-tylegw-internet_${DATEYEAR}${DATEMONTH}${DATEDAY}.mp4
